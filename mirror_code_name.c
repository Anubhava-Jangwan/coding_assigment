...
// Explanation: The first character moves to the last position,the second character
// moves to the second last position, and so on, effectively reversing the string.
